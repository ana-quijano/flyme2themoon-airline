Public Class frmAdminAssignAttendant
    Private Sub frmAdminAssignAttendant_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            End If
            'Select Statement for Attendant
            strSelect = "SELECT intAttendantID, strEmploymentStatus, strFirstName + ' ' + strLastName as AttendantName FROM TAttendants WHERE strEmploymentStatus <> 'Inactive'"
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Dim strFlight As String = cboFlight.Text
        Dim strAttendantName As String = cboAttendant.Text
        ...
        Try
            ...
            result = MessageBox.Show("Are you sure you want to assign Attendant " & strAttendantName & " to this flight from " & strFlight & "?", "Confirm Booking", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question)
            ...
            Select Case result
                ...
                Case DialogResult.Yes
                    ...
                    ' Select Statement to get intAttendantID
                    strSelect = "SELECT intAttendantID, strFirstName, strLastName
                                FROM TAttendants
                                WHERE strFirstName + ' ' + strLastName = '" & strAttendantName & "'"

                    cmdSelect = New OleDb.OleDbCommand(strSelect, m_conAdministrator)
                    drSourceTable = cmdSelect.ExecuteReader
                    drSourceTable.Read()

                    intAttendantID = CInt(drSourceTable("intAttendantID"))
